    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3 space-y-6">
          <GlassCard
            className={cn('p-6 border-t-2', DEPARTMENT_COLORS[teacher.department?.toLowerCase() as Department]?.border || 'border-border')}
            hover={false}
          >
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="font-display text-xl font-bold text-foreground">{teacher.name || 'Unknown Teacher'}</h1>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="rounded-full bg-secondary px-2.5 py-0.5 text-xs font-medium text-secondary-foreground">{teacher.subject || 'General'}</span>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 flex items-center gap-6">
              <div className="text-center">
                ...
                <StarDisplay rating={teacher.rating || 0} size={14} className="mt-1 justify-center" />
