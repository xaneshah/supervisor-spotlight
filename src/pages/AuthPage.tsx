                ...
                <div className="w-full max-w-md space-y-8 px-8">
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-muted-foreground">
                            {isLogin ? 'Enter your credentials to access your dashboard' : 'Sign up specifically with your university email'}
                        </p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    required
                                    className={`bg-white/50 dark:bg-zinc-800/50 border-white/10 focus:ring-indigo-500 ${!isLogin && email && !email.endsWith('@uni.edu.pk') ? 'border-red-500 focus:ring-red-500' : ''}`}
                                />
                                {!isLogin && email && !email.endsWith('@uni.edu.pk') && (
                                    <p className="text-xs text-red-500">Must be a @uni.edu.pk email address.</p>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    {isLogin && <a href="#" className="text-xs text-indigo-500 hover:text-indigo-400">Forgot password?</a>}
                                </div>
